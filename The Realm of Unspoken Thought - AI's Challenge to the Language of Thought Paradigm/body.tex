...
\begin{document}
	...
	Any discussion of "private language" must contend with Ludwig Wittgenstein's formidable argument in the \textit{Philosophical Investigations}. Wittgenstein famously questioned the possibility of a language "which describes my inner experiences and which only I myself can understand" \citep{wittgenstein1953}. His core critique targets the absence of an objective criterion for correct use in a purely private language, leading to the collapse of the distinction between following a rule and merely thinking one is following a rule \citep{wittgenstein1953}.
	...
	Wittgenstein's argument turns on the necessity of public criteria for rule-following embedded in a shared "form of life" (\textit{Lebensform}) \citep{wittgenstein1953}. A purely private rule lacks the external constraints that make rule-following possible.
